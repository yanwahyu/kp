...
function bind($p,$v,$t=null){if(is_null($t)){switch(true){case is_int($v):$t=PDO::PARAM_INT;break;case is_bool($v):$t=PDO::PARAM_BOOL;break;case is_null($v):$t=PDO::PARAM_NULL;break;default:$t=PDO::PARAM_STR;}}$this->st->bindValue($p,$v,$t);}
